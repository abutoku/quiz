...
const umiushi = [
   ...
   {
      question: './img/img_31.jpg',
      answers: ['センヒメウミウシ', 'シラヒメウミウシ', 'カグヤヒメウミウシ'],
      correct: 1,
      color: 'purple',
   },
   {
      question: './img/img_32.jpg',
      answers: ['キイボウミウシ', 'クロシタナシウミウシ', 'コイボウミウシ'],
      correct: 2,
      color: 'black',
   },
   {
      question: './img/img_33.jpg',
      answers: ['キヌハダモドキ', 'キンセンウミウシ', 'キヌハダウミウシ'],
      correct: 2,
      color: 'brown',
   },
   {
      question: './img/img_34.jpg',
      answers: ['ツマグロモウミウシ', 'アリモウミウシ', 'ツマグロミノウミウシ'],
      correct: 0,
      color: 'yellow',
   },
   {
      question: './img/img_35.jpg',
      answers: ['シラユキウミウシ', 'アラリウミウシ', 'ハナイロウミウシ'],
      correct: 2,
      color: 'white',
   },
   {
      question: './img/img_36.jpg',
      answers: ['ムカデミノウミウシ', 'サガミミノウミウシ', 'サキシマミノウミウシ'],
      correct: 1,
      color: 'purple',
   },
   {
      question: './img/img_37.jpg',
      answers: ['ムカデミノウミウシ', 'ハクセンミノウミウシ', 'サキシマミノウミウシ'],
      correct: 2,
      color: 'white',
   },
   {
      question: './img/img_38.jpg',
      answers: ['リュウモンイロウミウシ', 'タテスジウミウシ', 'リュウグウウミウシ'],
      correct: 0,
      color: 'blue',
   },
   {
      question: './img/img_39.jpg',
      answers: ['コソデウミウシ', 'フジタウミウシ', 'クロコソデウミウシ'],
      correct: 2,
      color: 'black',
   },
   {
      question: './img/img_40.jpg',
      answers: ['スミゾメミノウミウシ', 'サクラミノウミウシ', 'エムラミノウミウシ'],
      correct: 0,
      color: 'black',
   },
   {
      question: './img/img_41.jpg',
      answers: ['サガミミノウミウシ', 'サガミミノウミウシ', 'セスジミノウミウシ'],
      correct: 2,
      color: 'purple',
   },
   {
      question: './img/img_42.jpg',
      answers: ['アカエラミノウミウシ', 'サガミミノウミウシ', 'エムラミノウミウシ'],
      correct: 0,
      color: 'orange',
   },
   {
      question: './img/img_43.jpg',
      answers: ['フジイロウミウシ', 'ニシキウミウシ', 'ミヤコウミウシ'],
      correct: 1,
      color: 'purple',
   },
   {
      question: './img/img_44.jpg',
      answers: ['トゲトゲウミウシ', 'ヒロウミウシ', 'イガグリウミウシ'],
      correct: 2,
      color: 'yellow',
   },
   {
      question: './img/img_45.jpg',
      answers: ['ヒロウミウシ', 'シロウミウシ', 'サクラミノウミウシ'],
      correct: 0,
      color: 'red',
   },
   {
      question: './img/img_46.jpg',
      answers: ['メリべウミウシ', 'ショウジョウウミウシ', 'ハナオトメウミウシ'],
      correct: 1,
      color: 'red',
   },
   {
      question: './img/img_47.jpg',
      answers: ['サクラミノウミウシ', 'サガミミノウミウシ', 'セトミノウミウシ'],
      correct: 0,
      color: 'other',
   },
   {
      question: './img/img_48.jpg',
      answers: ['クリヤイロウミウシ', 'ハナイロミノウミウシ', 'フジイロウミウシ'],
      correct: 2,
      color: 'purple',
   },
...
$('.next_btn').on('click', function () {//goボタン、nextボタンが押されたら
   ...
   if (result.length < 10) { //問題が終了していれば反応しないようにする
      ...
      function count_check() {
         ...
         if (result.length === 10) { //回答数と問題数が一致したら
